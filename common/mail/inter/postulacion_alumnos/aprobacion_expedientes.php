...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <!-- row 1 -->
    <?php $nombreDir='aprobacion_expedientes';  ?>
  ...
  <tr>
    <!-- row 5 -->
    <td><img name="inter_email_r5_c2_2" src="<?= $message->embed(__DIR__.'/'.$nombreDir.'/inter_email_r5_c2.jpg'); ?>" width="98" height="257" border="0" alt="" /></td>
