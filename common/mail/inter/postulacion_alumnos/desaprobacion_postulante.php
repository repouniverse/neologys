...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <!-- row 1 -->
     <?php $nombreDir='desaprobacion_postulante';  ?>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><p class="style4">Por medio de la presente lamentamos comunicarte que; <br />
    siguiendo el reglamento interno del proceso de admisi&oacute;n de <br />
    la oficina de internacional, ya no ser&aacute; posible tu participaci&oacute;n en <br />
    el proceso de la convocatoria 2020 - II</p>
      <p class="style4">Estamos detallando las observaciones en los archivos de <br />
      evaluaci&oacute;n que se encuentran en la plataforma , el cual podr&aacute;s <br />
      revisarlo y tener en cuenta en las pr&oacute;ximas convocatorias que <br />
      deseas participar. </p>
      <p class="style4">&nbsp;</p>
      <table width="542" height="128" border="0">
        <tr>
          <td height="124" align="center" valign="middle" bgcolor="d7e2ee"><table width="518" border="0">
            <tr>
              <td width="512" height="82" valign="top"><span class="style7"><span class="style10">Agradecemos tu participaci&oacute;n y colaboraci&oacute;n durante el <br />
  proceso de postulaci&oacute;n.</span> <span class="style9">Asimismo, te exhortamos a que no te desanimes y refuerces los puntos observados para que <br />
              participes en la pr&oacute;xima convocatoria </span></span></td>
            </tr>
          </table></td>
        </tr>
      </table>
