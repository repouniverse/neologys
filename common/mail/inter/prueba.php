...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <!-- row 1 -->
    <td colspan="5"><img src="<?= $message->embed(yii::getAlias('@common/mail/internacional/imagenes/inter_email_r1_c1.jpg')); ?>" alt="" name="inter_email_r1_c1_2" width="800" height="195" border="0" usemap="#inter_email_r1_c1_2Map" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="195" border="0" /></td>
  </tr>
  <tr>
    <!-- row 2 -->
    <td colspan="5"><img name="inter_email_r2_c1_2" src="<?= $message->embed(yii::getAlias('@common/mail/internacional/imagenes/inter_email_r2_c1.jpg')); ?>" width="800" height="38" border="0" alt="" /></td>
  ...
  <tr>
    ...
    <td colspan="2"><span class="style1">ESTIMADO<br />
      FERNANDO RODOLDO ARMANDO BATISTA </span></td>
    <td colspan="2"><img name="<?= $message->embed(yii::getAlias('@common/mail/internacional/imagenes/inter_email_r3_c4.jpg')); ?>" width="268" height="72" border="0" alt="" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="72" border="0" /></td>
  </tr>
  <tr>
    <!-- row 4 -->
    <td colspan="4"><img name="inter_email_r4_c2_2" src="<?= $message->embed(yii::getAlias('@common/mail/internacional/imagenes/inter_email_r4_c2.jpg')); ?>" width="715" height="31" border="0" alt="" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="31" border="0" /></td>
  </tr>
  <tr>
    <!-- row 5 -->
    <td><img name="inter_email_r5_c2_2" src="<?= $message->embed(yii::getAlias('@common/mail/internacional/imagenes/inter_email_r5_c2.jpg')); ?>" width="98" height="257" border="0" alt="" /></td>
    <td colspan="2" valign="top"><p class="style4"><span class="style5">El motivo de la presente es para saludarte a la vez comunicarte que tus dosumentos fueron revisados y aprobados.</span><br />
    </p>
    <?php echo $content   ?>
    <p class="style2">&nbsp;</p></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <!-- row 6 -->
    <td colspan="5"><img name="inter_email_r6_c1_2" src="<?= $message->embed(yii::getAlias('@common/mail/internacional/imagenes/inter_email_r6_c1.jpg')); ?>" width="800" height="124" border="0" alt="" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="124" border="0" /></td>
  </tr>
  <tr>
    <!-- row 7 -->
    <td colspan="5"><img name="inter_email_r7_c1_2" src="imagenes/inter_email_r7_c1.jpg" width="800" height="1" border="0" alt="" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="1" border="0" /></td>
  </tr>
  <tr>
    <!-- row 8 -->
    <td colspan="5"><img src="<?= $message->embed($image_pie); ?>" alt="" name="<?= $message->embed(yii::getAlias('@common/mail/internacional/imagenes/inter_email_r8_c1.jpg')); ?>" width="800" height="210" border="0" usemap="#inter_email_r8_c1_2Map" /></td>
