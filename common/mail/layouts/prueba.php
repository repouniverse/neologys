...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <!-- row 1 -->
    <td colspan="5"><img src="imagenes/inter_email_r1_c1.jpg" alt="" name="inter_email_r1_c1_2" width="800" height="195" border="0" usemap="#inter_email_r1_c1_2Map" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="195" border="0" /></td>
  </tr>
  <tr>
    <!-- row 2 -->
    <td colspan="5"><img name="inter_email_r2_c1_2" src="imagenes/inter_email_r2_c1.jpg" width="800" height="38" border="0" alt="" /></td>
  ...
  <tr>
    ...
    <td colspan="2"><img name="inter_email_r3_c4_2" src="imagenes/inter_email_r3_c4.jpg" width="268" height="72" border="0" alt="" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="72" border="0" /></td>
  </tr>
  <tr>
    <!-- row 4 -->
    <td colspan="4"><img name="inter_email_r4_c2_2" src="imagenes/inter_email_r4_c2.jpg" width="715" height="31" border="0" alt="" /></td>
    <td><img src="imagenes/spacer.gif" alt="" name="undefined_2" width="1" height="31" border="0" /></td>
  </tr>
  <tr>
    <!-- row 5 -->
    <td><img name="inter_email_r5_c2_2" src="imagenes/inter_email_r5_c2.jpg" width="98" height="257" border="0" alt="" /></td>
    ...
    <p class="style2"><span class="style1">!FELICITACIONES&iexcl;<br />
      </span><span class="style3">Te adelantamos a seguir participando en este proceso <br />
        de postulaci&oacute;n que te brindar&aacute; grandes beneficios acad&eacute;micos.</span><span class="style1"><br />  
        <br />
      </span><span class="style3">Cordialmente.</span></p>
    <p class="style2">&nbsp;</p></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <!-- row 6 -->
    <td colspan="5"><img name="inter_email_r6_c1_2" src="imagenes/inter_email_r6_c1.jpg" width="800" height="124" border="0" alt="" /></td>
  ...
  <tr>
    <!-- row 8 -->
    <td colspan="5"><img src="<?= $message->embed($image_pie); ?>" alt="" name="inter_email_r8_c1_2" width="800" height="210" border="0" usemap="#inter_email_r8_c1_2Map" /></td>
