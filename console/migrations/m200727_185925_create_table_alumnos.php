...
{    
    ...
    public function safeUp()
    {
        ...
        if(!$this->existsTable($table))
        {
            $this->createTable
                   (
                        ...
                        [
                            ...
                            'mail' => $this->char(100)->append($this->collateColumn()),
                            'motivo' => $this->char(100)->append($this->collateColumn()),
                        ], $this->collateTable()
                   );
            ...
            $this->addForeignKey($this->generateNameFk($table), $table,'carrera_id', static::NAME_TABLE_CARRERAS,'id');
