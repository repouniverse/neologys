...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">APP</span><span class="logo-lg">' .Html::img('@web/img/logo_usmp_blanco.png',['width'=>280,'height'=>100]). '</span>',\yii\helpers\Url::home(), ['class' => 'logo']) ?>
