    ...
    <div class="box-body">
        <div class="asesores-curso-form">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php Pjax::begin(['id'=>'mi_grilla','timeout'=>false]);?>
                    ...
                    <?= GridView::widget([
                        'dataProvider' => new ActiveDataProvider([
                            'query' => \frontend\modules\repositorio\models\RepositorioAsesoresCursoDocs::find()->andWhere([
                            ...
                            [
                                ...
                                'buttons' => [
                                    ...
                                    'delete' => function ($url, $model) {
                                        if ($model->hasAttachments()) {
                                            $id_model = substr($model->urlFirstFile, strpos($model->urlFirstFile, "=") + 1);
                                            $url = Url::toRoute(['/repositorio/asesorcurso/ajax-delete-pdf', 'id' => $id_model]);
