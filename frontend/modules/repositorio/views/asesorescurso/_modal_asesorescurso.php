   ...
   <?php $form = ActiveForm::begin(['id'=>'form-asignar',
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
       ...
       <?= \common\widgets\buttonsubmitwidget\buttonSubmitWidget::widget(
                  ['idModal'=>$idModal,
                    'idForm'=>'form-asignar',
                      'url'=> ($model->isNewRecord)?\yii\helpers\Url::to(['/repositorio/asesorescurso/modal-asesorcurso','id'=>$matricula_id]):
                     \yii\helpers\Url::to(['/repositorio/asesorescurso/modal-update-asesorcurso','id'=>$model->id]),
                     'idGrilla'=>$gridName, 
                      ]
                  )?>
