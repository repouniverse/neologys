 ...
 */
class BuzonMensajeRespuestaSearch extends BuzonMensajeRespuesta
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id', 'bm_id'], 'integer'],
            [['bm_id','mensaje_respuesta', 'fecha_respuesta', 'hora_respuesta'], 'safe'],
        ];
    }
    ...
    {
        $query = BuzonMensajeRespuesta::find();
