    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        ...
        <?= GridView::widget([
            'dataProvider' => new ActiveDataProvider([
                'query' => frontend\modules\acad\models\AcadTramiteSyllabus::find()->select(['id', 'docu_id', 'user_id', 'aprobado', 'descripcion', 'focus', 'fecha_recibido', 'fecha_aprobacion'])
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) use ($userId) {
                        ...
                        $buton3 = '';
                        if ($model->focus) {
                            $link3 =  Url::toRoute(['/acad/syllabus/ajax-delete-observacion','id'=>$model->id]);
                            ...
                            if ($userId == $model->user_id) {
                                ...
                                if ($userId != $model->syllabus->docenteOwner->persona->profile->user_id) {
                                    ...
                                    if($model->hasObservaciones()){
                                        $buton3 = Html::a('<span class="fa fa-check"></span>Eliminar obs', '#', ['class' => 'btn btn-danger', 'id' => $model->id, 'title' => $link3, 'family' => 'holas']);
                                        $buton2 = '';
                                    }
                                }
