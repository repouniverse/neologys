...
class m201113_185239_rebuild_view_convocados extends viewMigration
{
  const NAME_VIEW='{{%inter_vw_convocados}}';
    ...
    ->select([
        ...
        'd.codalu as codigoalumno','d.codalu1','d.codalu2','d.carrera_id'  ,   'd.universidad_id as univorigen_id',
        'v.codesp','v.nombre',
     
        ])
    ->from(['a'=>'{{%inter_convocados}}'])->
    // innerJoin('{{%alumnos}} x', 'a.alumno_id=x.id')->           
