...
/**
 * Class m200804_144217_create_modalidades
 */
class m200804_144217_create_modalidades extends baseMigration
{
    const NAME_TABLE='{{%inter_modalidades}}';
        ...
        $this->createTable($table, [
            ...
            */
            ...
            'detalles'=>$this->text()->append($this->collateColumn()),
             'textoexterno'=>$this->text()->append($this->collateColumn()),
              'slogan'=>$this->text()->append($this->collateColumn()),
             'local'=>$this->char(1)->append($this->collateColumn()),
