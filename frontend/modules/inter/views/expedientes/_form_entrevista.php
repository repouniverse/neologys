...
<div class="box box-success">
    <div class="box box-body">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">            
            <?= $form->field($model, 'fechaprog',['enableAjaxValidation'=>true])->
                widget
                (
                    DatePicker::class, 
                    [
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <?= $form->field($model, 'finicio',['enableAjaxValidation'=>true])->
                widget
                (
                    DatePicker::class, 
                    [
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <?= $form->field($model, 'ftermino',['enableAjaxValidation'=>true])->
                widget
                (
                    DatePicker::class, 
                    [
