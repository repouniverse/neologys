...
$this->title = m::t('labels', 'Complete stage: {name}', [
...
?> .. 
    <div  class="aviso-success">
        <?php echo m::t('validaciones','Congratulations, you have completed the stage {etapa}',['etapa'=> frontend\modules\inter\models\InterEtapas::findOne($model->rawCurrentStage())->descripcion]);    ?>
    </div>
