 ...
 ?>
                ...
                <?php
                $gridName3='OpcionesUniversidad_2';
                
                Pjax::begin(['id'=>$gridName3]);
                        ...
                        [
                            ...
                            [
                                [
                                    ...
                                    'buttons' =>
                                    [
                                        'update' => function ($url, $model) use($gridName3)
                                                    {
                                                        $options = 
                                                        [
                                                        ...
                                                        $url= Url::to(['/maestros/default/modal-edit-evento-inter','id'=>$model->id,
                                                                       'gridName'=>$gridName3,'idModal'=>'buscarvalor','title' => m::t('base_labels','Agregar Unidad')]);
                ...
                <?php Pjax::end(); ?>      
                    ...
                    <p>
                        ...
                        $url= Url::to(['/maestros/default/modal-new-evento-inter','id'=>$model->id,
                                             'gridName'=>$gridName3,'idModal'=>'buscarvalor']);
