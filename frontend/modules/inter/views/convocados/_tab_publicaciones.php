 ...
 ?>
                ...
                <?php
                $gridName2='Opciorerersidryad';
                
                Pjax::begin(['id'=>$gridName2]);
                        ...
                        [
                            ...
                            [
                                [
                                    ...
                                    'buttons' =>
                                    [
                                        'update' => function ($url, $model) use($gridName2)
                                                    {
                                                        $options = 
                                                        [
                                                        ...
                                                        $url= Url::to(['/maestros/default/modal-edit-persona-publi','id'=>$model->id,
                                                                       'gridName'=>$gridName2,'idModal'=>'buscarvalor','title' => m::t('base_labels','Agregar Unidad')]);
                ...
                <?php Pjax::end(); ?>      
                    ...
                    <p>
                        ...
                        $url= Url::to(['/maestros/default/modal-new-persona-publi','id'=>$model->id,
                                             'gridName'=>$gridName2,'idModal'=>'buscarvalor']);
