    ...
    public function safeUp()
    {
        ...
        if (!$this->existsTable($table)) {
            $this->createTable($table, [
                ...
                //
                'ora_record_notas_check'=>$this->char(2)->defaultValue(null)->comment('SI->ORA presenta y adjunta record de notas'),
                ...
                //
                'aca_cursos_aptos_check'=>$this->char(2)->defaultValue(null)->comment('SI->ACA presenta y adjunta DOC DE CURSOS APTOS'),
                ...
                //
                'ora_cursos_aptos_check'=>$this->char(2)->defaultValue(null)->comment('SI->Ingresó información correctamente a los sistemas de SICAT/SAP'),
                ...
                //
                'oti_cursos_aptos_check'=>$this->char(2)->defaultValue(null)->comment('SI->Ingresó información de consolidado correctamente a SAP'),
                'oti_cursos_aptos_obs' => $this->text()->append($this->collateColumn())->comment('Observaciones de ingreso de información a SAP'),
                //
                'oti_notifica_email_check'=>$this->char(2)->defaultValue(null)->comment('SI->Envía correctamente email al alumno y a ACA:departamento académico'),
