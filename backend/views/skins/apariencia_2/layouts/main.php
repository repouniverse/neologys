...
elseif($accion=='signup'){
    ...
    \backend\views\skins\apariencia_2\AdminLteAsset::register($this);
    ...
    <head>
     ...
     <body class="hold-transition <?= \backend\views\skins\apariencia_2\AdminLteHelper::skinClass() ?>" sidebar-mini">
